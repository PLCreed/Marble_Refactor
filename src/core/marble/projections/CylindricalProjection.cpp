...
CylindricalProjectionPrivate::~CylindricalProjectionPrivate()
{}
                                                        ...
                                                        qreal repeatDistance) const
{
    ...
    {
        const int tessellatedNodes = qMin<int>(int(distance / finalTessellationPrecision), maxTessellationNodes);
