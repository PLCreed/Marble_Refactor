...
{
    return QObject::tr(
        "<p><b>Gnomonic Projection</b> (\"rectilinear\")</p><p>Applications: Used for displaying panorama photography. Also used for navigation, radio and seismic work.</p>");
}
                                           ...
                                           qreal &x, qreal &y, bool &globeHidesPoint) const
{
    ...
    const qint64 radius = qint64(clippingRadius() * viewport->radius());
