...
EquirectProjection::EquirectProjection() : CylindricalProjection()
{
...
{
    return QObject::tr(
        "<p><b>Equirectangular Projection</b> (\"Plate carrée\")</p><p>Applications: De facto standard for global texture data sets for computer software.</p>");
}
