...
public:
    /**
        ...
        inside the viewport.
     */
    GeoPainter(QPaintDevice *paintDevice, const ViewportParams *viewportParams,
    ...
    QRegion regionFromPixmapRect(const GeoDataCoordinates &centerCoordinates,
                                 int width, int height, int margin = 0) const;
    ...
    /**
        ...
        \see GeoDataLineString
     */
    void drawPolyline(const GeoDataLineString &lineString, const QString &labelText,
    ...
    void drawLabelsForPolygons(const QVector<QPolygonF *> &polygons, const QString &labelText,
    ...
    /**
        ...
        \see GeoDataCoordinates
     */
    QRegion regionFromRect(const GeoDataCoordinates &centerPosition, qreal width, qreal height,
                           bool isGeoProjected = false, qreal strokeWidth = 3) const;
    ...
    void drawRoundedRect(const GeoDataCoordinates &centerPosition,
                         qreal width, qreal height, qreal xRnd = 25.0, qreal yRnd = 25.0);
