...
TileCreatorDialog::TileCreatorDialog(TileCreator *creator, QWidget *parent) : QDialog(parent),
...
{
    const QString summary = QLatin1String("<b>") +
                            QCoreApplication::translate("DGML", name.toUtf8().constData()) +
                            QLatin1String("</b><br>") +
