...
GEODATA_EXPORT extern const char GeoDataCreateType[];
GEODATA_EXPORT extern const char GeoDataDataType[];
GEODATA_EXPORT extern const char GeoDataDeleteType[];
...
GEODATA_EXPORT extern const char GeoDataPlaylistType[];
...
GEODATA_EXPORT extern const char GeoDataSimpleDataType[];
GEODATA_EXPORT extern const char GeoDataSimpleFieldType[];
...
GEODATA_EXPORT extern const char GeoDataWaitType[];
