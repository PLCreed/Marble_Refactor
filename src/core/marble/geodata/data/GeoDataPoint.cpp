...
GeoDataPoint::GeoDataPoint() : GeoDataGeometry(new GeoDataPointPrivate)
{
    // nothing to do
}
...
GeoDataPoint::GeoDataPoint(const GeoDataPoint &other) : GeoDataGeometry(other)
{
    Q_D(GeoDataPoint);
...
GeoDataPoint::GeoDataPoint(const GeoDataCoordinates &other) : GeoDataGeometry(new GeoDataPointPrivate)
{
    Q_D(GeoDataPoint);
