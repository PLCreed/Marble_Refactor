...
public:
     ...
     * @param tessellate
     *  If tessellate is <code>true</code> then the LineString's line segments are
     *  bent and follow the earth's surface and terrain along great circles.
     *  If tessellate is <code>false</code> then the LineString's line segments are
     *  rendered as straight lines in screen coordinate space.
     */
     ...
     * @return The LineString is normalized, and pole corrected.
     * @note Deprecation Warning: This method will likely be removed from the public API.
     */
     ...
     * @note eprecation Warning: This method will likely be removed from the public API.
     */
    ...
    /**
     * @brief operator [] Returns a reference to the coordinates of a node at a given position.
     *                    This method does not detach the returned coordinate object from the line string.
     * @param pos
     */
    ...
    /**
     * @brief Returns a sub-string which contains elements from this vector, starting at position pos. If length is -1
    ...
    /**
     * @brief operator << Appends a given LineString to the end of the LineString.
     */
