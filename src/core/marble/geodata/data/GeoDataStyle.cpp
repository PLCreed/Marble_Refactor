...
GeoDataStyle::GeoDataStyle(const GeoDataStyle &other) : GeoDataStyleSelector(other),
    d(new GeoDataStylePrivate(*other.d))
{}

GeoDataStyle::GeoDataStyle(const QString &iconPath, const QFont &font, const QColor &color)
