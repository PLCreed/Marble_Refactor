...
public:
    ...
    /**
     * @brief Changes the differences between the boundaries and the center by the given factor,
     ...
     */
    static bool fuzzyCompare(const GeoDataLatLonBox &lhs, const GeoDataLatLonBox &rhs,
