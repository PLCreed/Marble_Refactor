 ...
 */
GeoDataCoordinates::GeoDataCoordinates() : d(null.d)
{
    d->ref.ref();
}
 ...
 * one to it at the end, if the number of references thus reaches 0 delete it
...
GeoDataCoordinates GeoDataCoordinates::interpolate(const GeoDataCoordinates &before, const GeoDataCoordinates &target,
                                                   const GeoDataCoordinates &after, double t_) const
{
    double const t = qBound(0.0, t_, 1.0);
