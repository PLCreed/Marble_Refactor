...
public:
    GeoDataDocumentPrivate() :  m_documentRole(UnknownDocument)
    {}

    GeoDataDocumentPrivate(const GeoDataDocumentPrivate &other) : GeoDataContainerPrivate(other),
...
GeoDataDocument::GeoDataDocument() : GeoDataContainer(new GeoDataDocumentPrivate)
{}

GeoDataDocument::GeoDataDocument(const GeoDataDocument &other) : GeoDocument(),
