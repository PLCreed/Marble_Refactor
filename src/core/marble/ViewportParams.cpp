...
{
public:
    ViewportParamsPrivate(Projection projection, qreal centerLongitude, qreal centerLatitude,
                          int radius, const QSize &size);
...
ViewportParamsPrivate::ViewportParamsPrivate(Projection projection, qreal centerLongitude,
                                             qreal centerLatitude, int radius, const QSize &size) :
...
ViewportParams::ViewportParams() : d(new ViewportParamsPrivate(Spherical, 0, 0, 2000, QSize(100, 100)))
{
    centerOn(d->m_centerLongitude, d->m_centerLatitude);
}

ViewportParams::ViewportParams(Projection projection, qreal centerLongitude, qreal centerLatitude,
                               int radius, const QSize &size)
...
bool ViewportParams::geoCoordinates(const int x, const int y, qreal &lon, qreal &lat,
