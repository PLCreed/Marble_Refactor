...
public:
    ...
    explicit ViewportParams(Projection projection,
                            ...
                            int radius = 2000, const QSize &size = QSize( 100, 100 ));
    ~ViewportParams();
     ...
     * @see ViewportParams
     */
    bool screenCoordinates(const GeoDataCoordinates &coordinates, qreal *x, qreal &y,
                           int &pointRepeatNum, const QSizeF &size, bool &globeHidesPoint) const;
