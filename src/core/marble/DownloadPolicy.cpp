...
DownloadPolicyKey::DownloadPolicyKey(const QStringList &hostNames, const DownloadUsage usage) :
    m_hostNames(hostNames),
    m_usage(usage)
{}

DownloadPolicyKey::DownloadPolicyKey(const QString &hostName, const DownloadUsage usage) :
