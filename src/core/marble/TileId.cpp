...
TileId TileId::fromCoordinates(const GeoDataCoordinates &coords, int zoomLevel)
{
    ...
    int lat = int(GeoDataCoordinates::normalizeLat(coords.latitude(GeoDataCoordinates::Degree),
                                                   GeoDataCoordinates::Degree) * 1000000);
    int lon = int(GeoDataCoordinates::normalizeLon(coords.longitude(GeoDataCoordinates::Degree),
                                                   GeoDataCoordinates::Degree) * 1000000);
    int x = 0;
    int y = 0;
